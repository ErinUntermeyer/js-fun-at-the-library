...
if (pages < 1000) {
  ...
  console.log("Ok, mayve I could read that in a day and a half");
};
...
if (isFavorite === true) {
  ...
  console.log(`I recenelty read the ${title} book`);
};
...
var book = ["Harry Potter", "Hunger Games", "This is a book", "JS Guide to Success", "Letters to a Young Chef"];
